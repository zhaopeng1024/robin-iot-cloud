...
import com.robin.iot.common.mqtt.convert.other.*;
...
public class MqttConversionService extends GenericConversionService {
    ...
    private static void init(MqttConversionService conversionService) {
        conversionService.addConverter((StringToByteArrayConverter) source -> source.getBytes(StandardCharsets.UTF_8));
        conversionService.addConverter((ByteArrayToStringConverter) source -> new String(source, StandardCharsets.UTF_8));
        conversionService.addConverter((ByteArrayToBooleanConverter) source -> Boolean.parseBoolean(new String(source, StandardCharsets.UTF_8)));
        conversionService.addConverter((ByteArrayToByteConverter) source -> Byte.parseByte(new String(source, StandardCharsets.UTF_8)));
        conversionService.addConverter((ByteArrayToShortConverter) source -> Short.parseShort(new String(source, StandardCharsets.UTF_8)));
        conversionService.addConverter((ByteArrayToIntegerConverter) source -> Integer.parseInt(new String(source, StandardCharsets.UTF_8)));
        conversionService.addConverter((ByteArrayToLongConverter) source -> Long.parseLong(new String(source, StandardCharsets.UTF_8)));
        conversionService.addConverter((ByteArrayToFloatConverter) source -> Float.parseFloat(new String(source, StandardCharsets.UTF_8)));
        conversionService.addConverter((ByteArrayToDoubleConverter) source -> Double.parseDouble(new String(source, StandardCharsets.UTF_8)));
